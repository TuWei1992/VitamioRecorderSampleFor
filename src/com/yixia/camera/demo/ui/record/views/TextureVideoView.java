...
public class TextureVideoView extends TextureView implements android.view.TextureView.SurfaceTextureListener {
	...
	public void updateVolumn() {
		try {
			...
			//			mSystemVolumn = mAudioManager.getStreamVolume(AudioManager.STREAM_MUSIC) * 1.0F / maxVolumn;
			mSystemVolumn = mAudioManager.getStreamVolume(AudioManager.STREAM_MUSIC);
...
//				Logger.e("simon", "mSystemVolumn>>>>>"+mSystemVolumn);
	...
	MediaPlayer.OnVideoSizeChangedListener mVideoSizeChangedListener = new OnVideoSizeChangedListener() {
	...
	MediaPlayer.OnInfoListener mInfoListener = new OnInfoListener() {
